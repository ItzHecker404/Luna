...
rawowners = "<h1 style='text-align: center'>Modified by <a href='https://www.youtube.com/watch?v=dQw4w9WgXcQ'>Huh ?</a></h1>"
...
<body>
    ...
    <header>
        ...
        <div class="social">
            <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ"><i class="fab fa-github"></i></a>
            <a href="https://t.me/sid_gil"><i class="fab fa-telegram"></i></a>
        </div>
    </header>
    <!-- pin_entry -->
    <!-- files_list -->
